        ...
        return (
            <section className="content__row content__row--full-width contact__section" data-id={_.get(section, 'section_id', null)}>
              ...
              <div className="contact__text-container">
                <h3 className="contact__title">了解产品? <br/>联系我们</h3>
                <div className="contact__info-container">
                  <p className="contact__address">地址：{_.get(section, 'address', null)}</p>
                  <p className="contact__telephone">手机：{_.get(section, 'phone', null)}</p>
                  <p className="contact__email">邮箱：{_.get(section, 'email', null)}</p>
